...
public class SharingCarHeuristicFunction2 implements HeuristicFunction  {
  ...
  public boolean equals(Object obj) {
    ...
    public int getHeuristicValue(Object state) {
            ...
            for(int i=0; i < minDists.size(); i++){  //Si alguna de las distancias minimas pasa de 30km, penalizamos la diferencia*1000
                ...
                else if (board.getBoard().get(i).size()== 1)heurValue += 1000000;
                else heurValue += currDist;
             }
            heurValue /= (SharingCarBoard.ncond - board.getBoard().size() + 1);
